					...
					if($level=="admin")
					{
						...
						<div class="container-fluid">
							...
							<?php
								...
								$querya="SELECT * FROM petugas WHERE id_petugas='$id_petugas'";
							...
							?>
								<div class="col-sm-10">
									<div class="panel panel-danger">
										<div class="panel-heading" style="color: black;"> HALAMAN EDIT OLAH PETUGAS </div>
										<div class="panel-body"> 
											<div class="container-fluid">
												<form action="update_olah_petugas.php" method="POST">
													<div class="form-group">
														<label for="id_petugas">ID Petugas:</label>
														<input type="text" class="form-control" name="id_petugas" id="id_petugas" placeholder="ID Barang" value="<?php echo $dataa['id_petugas']; ?>" readonly>
													</div>
													<div class="form-group">
													...
													<div class="form-group">
														...
														<input type="text" class="form-control" name="level" id="level" value="<?php echo $dataa['level']; ?>" readonly>
													</div>
