										...
										<ul class="navbar-nav">
											...
											<li class="nav-item">
												...
												<div id="demo" class="collapse">
													<ul class="navbar-nav">
														<li class="nav-item">
															<a class="nav-link navbar-light" href="admin/data_petugas.php">Tambah Petugas</a>
															<a class="nav-link navbar-light" href="admin/olah_petugas.php">Olah Petugas</a>
														</li>
													</ul>
												</div>
											</li>
											<li class="nav-item">
												<a class="nav-link" href="admin/generate_laporan.php">Generate Laporan</a>
											</li>
										</ul>
									</nav>
								</div>
								...
								<div class="col-sm-2">
									<nav class="navbar bg-light navbar-light">
										<ul class="navbar-nav">
											...
											<li class="nav-item">
												<a class="nav-link" href="petugas/verifikasi.php">Verifikasi Pengaduan</a>
											</li>
											<li class="nav-item">
												<a class="nav-link" href="petugas/tanggapan.php">Beri Tanggapan</a>
											</li>
										</ul>
									</nav>
								</div>
