					...
					else if($level=="petugas")
					{
						...
						<div class="container-fluid">
							<div class="row">
								...
								<div class="col-sm-10">
									<div class="panel panel-danger">
										<div class="panel-heading" style="color: black;"> HALAMAN JAWAB TANGGAPAN </div>
										<div class="panel-body"> 
											<form action="update_tanggapan.php" method="POST">
												...
												<div class="form-group">
													...
													<input type="text" class="form-control" name="tgl_tanggapan" id="tgl_tanggapan" value="<?php echo date('Y-d-m'); ?>" style="width: 20%;" required>
												</div>
												<div class="form-group">
													<label for="tanggapan">Tanggapan:</label>
													<textarea type="text" class="form-control" name="tanggapan" id="tanggapan" placeholder="Tanggapan" style="width: 50%;" required></textarea>
												</div>
												<div class="form-group">
													<?php
													$id_petugas=$data['id_petugas'];
													$sqla=mysqli_query($koneksi,"SELECT * FROM petugas WHERE id_petugas='$id_petugas'");
													while($datab=mysqli_fetch_array($sqla))
													{
													?>
													<label for="id_petugas">ID Petugas:</label>
													<input type="text" class="form-control" name="id_petugas" id="id_petugas" value="<?php echo $datab['id_petugas']; ?>" style="width: 20%;" required readonly>
													<?php
													}
													?>
												</div>
