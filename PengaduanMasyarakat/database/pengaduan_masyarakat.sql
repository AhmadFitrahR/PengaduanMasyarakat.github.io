...
--
-- Host: 127.0.0.1
-- Generation Time: 16 Feb 2020 pada 21.35
...
CREATE TABLE `masyarakat` (
  ...
  `status` enum('masyarakat') NOT NULL
...
INSERT INTO `masyarakat` (`nik`, `nama`, `username`, `password`, `telp`, `status`) VALUES
('3200033230290', 'Taupik Ramadhan', 'taupik', '827ccb0eea8a706c4c34a16891f84e7b', '089609869810', 'masyarakat');
...
(2, '2020-16-02', '3200033230290', 'Taupik Ramadhan', 'Jalan Nya Rusak Sekali !!!', 'Hydrangeas.jpg', 'proses');
...
(1, 'Ahmad Fitrah R', 'admin', '827ccb0eea8a706c4c34a16891f84e7b', '089609869810', 'admin'),
(2, 'Hareka Legidzul', 'petugas', '827ccb0eea8a706c4c34a16891f84e7b', '089609869812', 'petugas');
...
(1, 2, '2020-16-02', 'Kami Akan Segera Memperbaiki...', 2);
